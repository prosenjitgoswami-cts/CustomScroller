...
- (NSURL *)applicationDocumentsDirectory {
        ...
        // code uses a directory named "CTS.COM.TestProject0001" in the application's
        // documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"TestProject0001"
                                              withExtension:@"momd"];
    _managedObjectModel =
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory]
                       URLByAppendingPathComponent:@"TestProject0001.sqlite"];
    NSError *error = nil;
